                ...
                <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                  <div class="card shadow-2-strong" style="border-radius: 1rem;">
                    ...
                    <form:form method="post" action="/user/register" modelAttribute="user">
                      ...
                      <div class="form-outline mb-4">
                        <form:input type="password" id="typePasswordX-2" class="form-control form-control-lg password" path="password" placeholder="Password"/>
                      </div>

                      <div class="form-outline mb-4 otp" style="display: none;">
